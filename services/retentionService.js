 ...
 * Implements calibrated logistic regression & behavioral feature scoring inspired by churn.ipynb.
 */
...
function computeChurnMetrics({
  ...
  // Weighted multi-modal platform engagement
  ...
  // Calibrated weights based on student persistence modeling
...
function getCohortAnalytics() {
  return {
    segments: [
      ...
      { name: 'Steady Learners', percentage: 33, count: 330, color: '#3b82f6', description: 'Regular quizzes & material reviews' },
      { name: 'At-Risk Students', percentage: 18, count: 180, color: '#f59e0b', description: 'Inactivity 3-7 days, declining streak' },
      { name: 'Dormant Accounts', percentage: 7, count: 70, color: '#ef4444', description: 'Inactive > 14 days, zero quizzes' }
    ],
    weeklyCohort: [
      { week: 'Week 1', retentionRate: 100, activeStudents: 1000 },
      { week: 'Week 2', retentionRate: 86, activeStudents: 860 },
      { week: 'Week 3', retentionRate: 74, activeStudents: 740 },
      { week: 'Week 4', retentionRate: 68, activeStudents: 680 },
      { week: 'Week 5', retentionRate: 62, activeStudents: 620 },
      { week: 'Week 6', retentionRate: 58, activeStudents: 580 },
      { week: 'Week 7', retentionRate: 55, activeStudents: 550 }
    ]
  };
}
